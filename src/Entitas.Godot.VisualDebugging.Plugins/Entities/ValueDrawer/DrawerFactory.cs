...
public static class DrawerFactory
{
  ...
  static DrawerFactory()
  {
    ...
    _factories.Add(typeof(byte), () => new ByteValueDrawer());
    _factories.Add(typeof(short), () => new ShortValueDrawer());
    _factories.Add(typeof(ushort), () => new UShortValueDrawer());
    _factories.Add(typeof(int), () => new IntValueDrawer());
    _factories.Add(typeof(uint), () => new UIntValueDrawer());
    _factories.Add(typeof(long), () => new LongValueDrawer());
    _factories.Add(typeof(ulong), () => new ULongValueDrawer());
    ...
    _factories.Add(typeof(PackedScene), () => new PackedSceneValueDrawer());
  }

  public static BaseValueDrawer CreateDrawer(this Type type)
  {
    if (_factories.TryGetValue(type, out Func<BaseValueDrawer> factory)) return factory.Invoke();
    
    if (type.IsEnum) return new EnumValueDrawer();
